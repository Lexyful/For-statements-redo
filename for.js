...
for (var i = 25; i < 75; i++) {
  console.log('filter');
  // the 'filter' array method is meant to  return a new array containing only the even numbers
...
//   console.log(`it's been a beautiful ${weather_options[i]} day`)
// } 
// i'm having a hard time getting this code to run without errors
...
// const array = ["car", "bike", "bus", "van", "scooter", "truck", "rv"]
// array.forEach(item => {if(item.length%3 == 1)  console.log(item)});
// this method is meant to pick out strings that are 3 characters in length
